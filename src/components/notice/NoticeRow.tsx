...
export default function NoticeRow({ notice }: NoticeRowProps) {
  const { title, date, isPinned } = notice;

  if (isPinned) {
    return (
      <div className="flex items-center justify-between rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
  ...
  return (
    <div className="flex items-center justify-between border-b border-charcoal/10 px-2 py-5">
